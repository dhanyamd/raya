...
const Header = ({ user, workspace }: Props) => {
  ...
  return (
    <header className='grid grid-cols-5 grid-rows-1 gap-2 overflow-x-auto overflow-hidden p-2 border'>
      <div className='col-span-2 flex items-center space-x-2 hover:cursor-pointer hover:opacity-80 px-4'>
        <Badge className='text-purple-500' size={22} />
        <p className='text-purple-500 font-bold text-xl'>Raya</p>
